...
def create_question_with_one_choice(question_text, days):
    """
...
class QuestionIndexViewTests(TestCase):
    ...
    def test_past_question(self):
        ...
        """
        create_question_with_two_choices(question_text="Past question.", days=-30)
        response = self.client.get(reverse('polls:index'))
    ...
    def test_two_past_questions(self):
        ...
        And questions must have more then on choice.
        """
        create_question_with_two_choices(question_text="Past question 1.", days=-30)
        create_question_with_two_choices(question_text="Past question 2.", days=-5)
        response = self.client.get(reverse('polls:index'))
        self.assertQuerysetEqual(
        response.context['latest_question_list'],
    ...
    def test_question_with_no_choice(self):
        ...
        """
        question_with_no_choice = create_question(question_text="The Question with no choices.", days=-5)
        response = self.client.get(reverse('polls:index'))
        self.assertContains(response, "No polls are available.")
        self.assertQuerysetEqual(response.context['latest_question_list'], [])
