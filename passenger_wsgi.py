...
#######################################################
### PYTHON APP ÇALIŞABİLMESİ İÇİN GERKLİ           ####
### PASSENGER_WSGI.PY DOSYASI BU ŞEKİLDE OLMALI    ####
######################################################

#########Accessing the App's Default WSGI##############
import ship_management.wsgi

application = ship_management.wsgi.application

######## PASSENGER PATH INFO-FIX INITIALISATIONS#######
cwd = os.getcwd()
sys.path.append(cwd)
#sys.path.append(os.getcwd())
sys.path.append(cwd + '/ship_management')  #You must add your project here
